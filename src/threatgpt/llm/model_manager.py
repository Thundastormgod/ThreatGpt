"""Model management utilities for ThreatGPT local models.
    ...
    def get_system_requirements(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if memory_gb >= 32:
                ...
                recommendations.append("️  Limited RAM (8GB) - Stick to small models (1B-3B parameters)")
            else:
                recommendations.append(" Insufficient RAM (<8GB) - Local models not recommended")
            
            if gpu_available and gpu_memory_gb >= 8:
                recommendations.append(" GPU available with good VRAM - Use Hugging Face provider for best performance")
            elif gpu_available:
                recommendations.append("️  GPU available but limited VRAM - Consider quantized models")
            else:
                recommendations.append("ℹ️  No GPU detected - Use Ollama or llama.cpp for CPU inference")
